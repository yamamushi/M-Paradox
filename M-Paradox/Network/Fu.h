...
#ifndef M_Paradox_Fu_h
#define M_Paradox_Fu_h
...
class Telnet_Protocol_Handler
{
    
public:
    
    Telnet_Protocol_Handler(int BUFFSIZE) : currentState(STATE_DATA), pool(BUFFSIZE + 1), // + 1 for '\0'
...
private:
    ...
    r* data = (unsigned char*)pool.malloc();
